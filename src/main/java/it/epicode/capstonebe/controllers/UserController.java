...
public class UserController {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    public User saveUser(@RequestBody UserAdminDTO userDTO, BindingResult bindingResult) throws NotFoundException, BadRequestException, InternalServerErrorException {

        HandlerException.notFoundException(bindingResult);
        return userService.saveWithRole(userDTO);

    }

    @PatchMapping("/admin/update/{id}")
    @PreAuthorize("hasAuthority('ADMIN')")
    public User updateUser(@PathVariable UUID id, @RequestBody UserUpdateDTO userDTO, BindingResult bindingResult) throws NotFoundException, BadRequestException, InternalServerErrorException {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    public DeleteRes deleteUser(@PathVariable UUID id) throws NotFoundException, BadRequestException{
